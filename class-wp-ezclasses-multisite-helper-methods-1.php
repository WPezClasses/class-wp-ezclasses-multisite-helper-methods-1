 ...
 *
 * As inspired by (@link https://core.trac.wordpress.org/ticket/29411) and (@link http://wordpress.org/plugins/wp-multi-network/)
 *
 * PHP version 5.3
 *
 * LICENSE: TODO
...
if (! class_exists('Class_WP_ezClasses_Multisite_Helper_Methods_1') ) {
  class lass_WP_ezClasses_Multisite_Helper_Methods_1 extends Class_WP_ezClasses_Master_Singleton {
	...
	// FROM http://wordpress.org/plugins/wp-multi-network/
	
	// TODO - review, cleanup, ez-ize, add stuff
